# 4.4 Setup -------------------------------------------------------------------
# 4.4.1 (Installiere und) lade das Paket skimr
library(skimr)


# 4.4.2 Daten einlesen
...
# 4.5.5 Mittelwerte, Standardabweichungen und fehlende Werte ermitteln
# Führe folgenden Code aus um die die Mittelwerte, den Median, 
# die Standardabweichungen und die fehlenden Werte für folgenden Variablen 
